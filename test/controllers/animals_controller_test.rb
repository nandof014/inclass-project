...
class AnimalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post animals_url, params: { animal: { name: @animal.name, owner_id: @animal.owner_id } }
    end
  ...
  test "should update animal" do
    patch animal_url(@animal), params: { animal: { name: @animal.name, owner_id: @animal.owner_id } }
